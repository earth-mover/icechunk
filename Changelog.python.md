...
- Garbage collection lists 32 ways in parallel on S3 and GCS, one listing per possible first character of an object id. Listing a 2.8 million object repository drops from 299 s to 15 s. Azure and local storage keep a single listing ([#2371](https://github.com/earth-mover/icechunk/pull/2371), [#TBD](https://github.com/earth-mover/icechunk/pull/TBD)).
