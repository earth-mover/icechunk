...
pub mod generated {
    ...
    impl<'a> ChunkRef<'a> {
        ...
        pub const VT_EXTRA: ::flatbuffers::VOffsetT = 22;
        ...
        pub fn index(&self) -> ::flatbuffers::Vector<'a, u32> {
            ...
            // which contains a valid value in this slot
            unsafe {
                self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, u32>>>(ChunkRef::VT_INDEX, None).unwrap()
            }
        }
        #[inline]
    ...
    impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> ChunkRefBuilder<'a, 'b, A> {
        ...
        pub fn add_extra(
            &mut self,
            extra: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b, u8>>,
        ) {
            self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(
                ChunkRef::VT_EXTRA,
                extra,
            ...
            unsafe {
                self._tab
                    .get::<::flatbuffers::ForwardsUOffset<
                        ::flatbuffers::Vector<
                            'a,
                            ::flatbuffers::ForwardsUOffset<ChunkRef>,
                        >,
    ...
    pub struct ManifestArgs<'a> {
        ...
        pub arrays: Option<
            ::flatbuffers::WIPOffset<
                ::flatbuffers::Vector<
                    'a,
                    ::flatbuffers::ForwardsUOffset<ArrayManifest<'a>>,
                >,
            >,
        >,
    ...
    impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> ManifestBuilder<'a, 'b, A> {
        ...
        pub fn add_arrays(
            ...
            arrays: ::flatbuffers::WIPOffset<
                ::flatbuffers::Vector<
                    'b,
                    ::flatbuffers::ForwardsUOffset<ArrayManifest<'b>>,
                >,
            >,
        ) {
            self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(
    ...
    pub enum ManifestFileInfoV2Offset {}
    #[derive(Copy, Clone, PartialEq)]

    pub struct ManifestFileInfoV2<'a> {
        pub _tab: ::flatbuffers::Table<'a>,
    }

    impl<'a> ::flatbuffers::Follow<'a> for ManifestFileInfoV2<'a> {
        type Inner = ManifestFileInfoV2<'a>;
        #[inline]
        unsafe fn follow(buf: &'a [u8], loc: usize) -> Self::Inner {
            Self { _tab: unsafe { ::flatbuffers::Table::new(buf, loc) } }
        }
    ...
    impl<'a> ManifestFileInfoV2<'a> {
        pub const VT_ID: ::flatbuffers::VOffsetT = 4;
        pub const VT_SIZE_BYTES: ::flatbuffers::VOffsetT = 6;
        pub const VT_NUM_CHUNK_REFS: ::flatbuffers::VOffsetT = 8;
        pub const VT_EXTRA: ::flatbuffers::VOffsetT = 10;

        #[inline]
        pub unsafe fn init_from_table(table: ::flatbuffers::Table<'a>) -> Self {
            ManifestFileInfoV2 { _tab: table }
        }
        #[allow(unused_mut)]
        pub fn create<
            'bldr: 'args,
        ...
        >(
            _fbb: &'mut_bldr mut ::flatbuffers::FlatBufferBuilder<'bldr, A>,
            args: &'args ManifestFileInfoV2Args<'args>,
        ) -> ::flatbuffers::WIPOffset<ManifestFileInfoV2<'bldr>> {
            let mut builder = ManifestFileInfoV2Builder::new(_fbb);
            builder.add_size_bytes(args.size_bytes);
            if let Some(x) = args.extra {
                builder.add_extra(x);
            }
            builder.add_num_chunk_refs(args.num_chunk_refs);
            if let Some(x) = args.id {
                builder.add_id(x);
            }
            builder.finish()
        ...
        #[inline]
        pub fn id(&self) -> Option<&'a ObjectId12> {
            // Safety:
            // Created from valid Table for this object
            // which contains a valid value in this slot
            unsafe { self._tab.get::<ObjectId12>(ManifestFileInfoV2::VT_ID, None) }
        }
        #[inline]
        pub fn size_bytes(&self) -> u64 {
            // Safety:
            ...
            // which contains a valid value in this slot
            unsafe {
                self._tab.get::<u64>(ManifestFileInfoV2::VT_SIZE_BYTES, Some(0)).unwrap()
            }
        }
        #[inline]
        pub fn num_chunk_refs(&self) -> u32 {
            ...
            unsafe {
                self._tab
                    .get::<u32>(ManifestFileInfoV2::VT_NUM_CHUNK_REFS, Some(0))
                    .unwrap()
            }
        }
        #[inline]
    ...
    impl ::flatbuffers::Verifiable for ManifestFileInfoV2<'_> {
        #[inline]
        fn run_verifier(
            v: &mut ::flatbuffers::Verifier,
            pos: usize,
            ...
            v.visit_table(pos)?
     .visit_field::<ObjectId12>("id", Self::VT_ID, false)?
     .visit_field::<u64>("size_bytes", Self::VT_SIZE_BYTES, false)?
     .visit_field::<u32>("num_chunk_refs", Self::VT_NUM_CHUNK_REFS, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'_, u8>>>("extra", Self::VT_EXTRA, false)?
     .finish();
            Ok(())
        }
    }
    pub struct ManifestFileInfoV2Args<'a> {
        pub id: Option<&'a ObjectId12>,
        pub size_bytes: u64,
        pub num_chunk_refs: u32,
        pub extra: Option<::flatbuffers::WIPOffset<::flatbuffers::Vector<'a, u8>>>,
    }
    impl<'a> Default for ManifestFileInfoV2Args<'a> {
        #[inline]
        fn default() -> Self {
            ManifestFileInfoV2Args {
                id: None,
                size_bytes: 0,
                num_chunk_refs: 0,
                extra: None,
    ...
    pub struct ManifestFileInfoV2Builder<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> {
        fbb_: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
        start_: ::flatbuffers::WIPOffset<::flatbuffers::TableUnfinishedWIPOffset>,
    }
    impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> ManifestFileInfoV2Builder<'a, 'b, A> {
        #[inline]
        pub fn add_id(&mut self, id: &ObjectId12) {
            self.fbb_.push_slot_always::<&ObjectId12>(ManifestFileInfoV2::VT_ID, id);
        }
        #[inline]
        pub fn add_size_bytes(&mut self, size_bytes: u64) {
            self.fbb_.push_slot::<u64>(ManifestFileInfoV2::VT_SIZE_BYTES, size_bytes, 0);
        }
        #[inline]
        pub fn add_num_chunk_refs(&mut self, num_chunk_refs: u32) {
            self.fbb_.push_slot::<u32>(
                ManifestFileInfoV2::VT_NUM_CHUNK_REFS,
                num_chunk_refs,
                0,
            );
        }
        ...
        pub fn new(
            _fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
        ) -> ManifestFileInfoV2Builder<'a, 'b, A> {
            let start = _fbb.start_table();
            ManifestFileInfoV2Builder { fbb_: _fbb, start_: start }
        }
        #[inline]
        pub fn finish(self) -> ::flatbuffers::WIPOffset<ManifestFileInfoV2<'a>> {
            let o = self.fbb_.end_table(self.start_);
            ::flatbuffers::WIPOffset::new(o.value())
        }
    }

    impl ::core::fmt::Debug for ManifestFileInfoV2<'_> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            let mut ds = f.debug_struct("ManifestFileInfoV2");
            ds.field("id", &self.id());
            ds.field("size_bytes", &self.size_bytes());
            ds.field("num_chunk_refs", &self.num_chunk_refs());
            ds.field("extra", &self.extra());
            ds.finish()
        }
    }
    ...
    impl<'a> ManifestRef<'a> {
        ...
        pub fn extents(&self) -> ::flatbuffers::Vector<'a, ChunkIndexRange> {
            ...
            unsafe {
                self._tab
                    .get::<::flatbuffers::ForwardsUOffset<
                        ::flatbuffers::Vector<'a, ChunkIndexRange>,
                    >>(ManifestRef::VT_EXTENTS, None)
                    .unwrap()
            }
        }
    }
        ...
        fn run_verifier(
            ...
            v.visit_table(pos)?
                ...
                .visit_field::<::flatbuffers::ForwardsUOffset<
                    ::flatbuffers::Vector<'_, ChunkIndexRange>,
                >>("extents", Self::VT_EXTENTS, true)?
                .finish();
            Ok(())
        }
    }
    ...
    impl<'a> ArrayNodeData<'a> {
        ...
        pub fn shape(&self) -> ::flatbuffers::Vector<'a, DimensionShape> {
            ...
            unsafe {
                self._tab
                    .get::<::flatbuffers::ForwardsUOffset<
                        ::flatbuffers::Vector<'a, DimensionShape>,
                    >>(ArrayNodeData::VT_SHAPE, None)
                    .unwrap()
            }
        }
        #[inline]
        ...
        > {
            ...
            unsafe {
                self._tab.get::<::flatbuffers::ForwardsUOffset<
                    ::flatbuffers::Vector<
                        'a,
                        ::flatbuffers::ForwardsUOffset<DimensionName>,
                    >,
    ...
    pub struct ArrayNodeDataArgs<'a> {
        ...
        pub dimension_names: Option<
            ::flatbuffers::WIPOffset<
                ::flatbuffers::Vector<
                    'a,
                    ::flatbuffers::ForwardsUOffset<DimensionName<'a>>,
                >,
            >,
        >,
        pub manifests: Option<
            ::flatbuffers::WIPOffset<
                ::flatbuffers::Vector<
                    'a,
                    ::flatbuffers::ForwardsUOffset<ManifestRef<'a>>,
                >,
            >,
        >,
        pub shape_v2: Option<
    ...
    impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> ArrayNodeDataBuilder<'a, 'b, A> {
        ...
        pub fn add_dimension_names(
            ...
            dimension_names: ::flatbuffers::WIPOffset<
                ::flatbuffers::Vector<
                    'b,
                    ::flatbuffers::ForwardsUOffset<DimensionName<'b>>,
                >,
            >,
        ) {
            self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(
        ...
        pub fn add_manifests(
            ...
            manifests: ::flatbuffers::WIPOffset<
                ::flatbuffers::Vector<
                    'b,
                    ::flatbuffers::ForwardsUOffset<ManifestRef<'b>>,
                >,
            >,
        ) {
            self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(
    ...
    impl<'a> Snapshot<'a> {
        ...
        pub const VT_MANIFEST_FILES_V2: ::flatbuffers::VOffsetT = 18;
        ...
        >(
            ...
            if let Some(x) = args.manifest_files_v2 {
                builder.add_manifest_files_v2(x);
            }
        ...
        #[inline]
        pub fn manifest_files_v2(
            &self,
        ) -> Option<
            ::flatbuffers::Vector<
                'a,
                ::flatbuffers::ForwardsUOffset<ManifestFileInfoV2<'a>>,
            >,
        > {
            // Safety:
            // Created from valid Table for this object
            ...
            unsafe {
                self._tab.get::<::flatbuffers::ForwardsUOffset<
                    ::flatbuffers::Vector<
                        'a,
                        ::flatbuffers::ForwardsUOffset<ManifestFileInfoV2>,
                    >,
                >>(Snapshot::VT_MANIFEST_FILES_V2, None)
            }
        }
        #[inline]
        pub fn extra(&self) -> Option<::flatbuffers::Vector<'a, u8>> {
    ...
    impl ::flatbuffers::Verifiable for Snapshot<'_> {
     ...
     .visit_field::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'_, ::flatbuffers::ForwardsUOffset<ManifestFileInfoV2>>>>("manifest_files_v2", Self::VT_MANIFEST_FILES_V2, false)?
     .visit_field::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'_, u8>>>("extra", Self::VT_EXTRA, false)?
     .finish();
            Ok(())
        }
    ...
    pub struct SnapshotArgs<'a> {
        ...
        pub nodes: Option<
            ::flatbuffers::WIPOffset<
                ::flatbuffers::Vector<
                    'a,
                    ::flatbuffers::ForwardsUOffset<NodeSnapshot<'a>>,
                >,
            >,
        >,
        pub flushed_at: u64,
        ...
        pub metadata: Option<
            ::flatbuffers::WIPOffset<
                ::flatbuffers::Vector<
                    'a,
                    ::flatbuffers::ForwardsUOffset<MetadataItem<'a>>,
                >,
            >,
        >,
        pub manifest_files:
            Option<::flatbuffers::WIPOffset<::flatbuffers::Vector<'a, ManifestFileInfo>>>,
        pub manifest_files_v2: Option<
            ::flatbuffers::WIPOffset<
                ::flatbuffers::Vector<
                    'a,
                    ::flatbuffers::ForwardsUOffset<ManifestFileInfoV2<'a>>,
    ...
    impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> SnapshotBuilder<'a, 'b, A> {
        ...
        pub fn add_nodes(
            ...
            nodes: ::flatbuffers::WIPOffset<
                ::flatbuffers::Vector<
                    'b,
                    ::flatbuffers::ForwardsUOffset<NodeSnapshot<'b>>,
                >,
            >,
        ) {
            self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(
        ...
        pub fn add_metadata(
            ...
            metadata: ::flatbuffers::WIPOffset<
                ::flatbuffers::Vector<
                    'b,
                    ::flatbuffers::ForwardsUOffset<MetadataItem<'b>>,
                >,
            >,
        ) {
            self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(
        ...
        #[inline]
        pub fn add_manifest_files_v2(
            &mut self,
            manifest_files_v2: ::flatbuffers::WIPOffset<
                ::flatbuffers::Vector<
                    'b,
                    ::flatbuffers::ForwardsUOffset<ManifestFileInfoV2<'b>>,
                >,
            >,
        ) {
            self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(
                Snapshot::VT_MANIFEST_FILES_V2,
                manifest_files_v2,
            );
        }
        #[inline]
    ...
    impl ::core::fmt::Debug for Snapshot<'_> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            ...
            ds.field("manifest_files_v2", &self.manifest_files_v2());
            ds.field("extra", &self.extra());
            ds.finish()
        }
    }
    ...
    impl<'a> ChunkIndices<'a> {
        ...
        pub fn coords(&self) -> ::flatbuffers::Vector<'a, u32> {
            ...
            // which contains a valid value in this slot
            unsafe {
                self._tab.get::<::flatbuffers::ForwardsUOffset<::flatbuffers::Vector<'a, u32>>>(ChunkIndices::VT_COORDS, None).unwrap()
            }
        }
    }
    ...
    pub struct ArrayUpdatedChunksArgs<'a> {
        ...
        pub chunks: Option<
            ::flatbuffers::WIPOffset<
                ::flatbuffers::Vector<
                    'a,
                    ::flatbuffers::ForwardsUOffset<ChunkIndices<'a>>,
                >,
            >,
        >,
    }
    ...
    impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> ArrayUpdatedChunksBuilder<'a, 'b, A> {
        ...
        pub fn add_chunks(
            ...
            chunks: ::flatbuffers::WIPOffset<
                ::flatbuffers::Vector<
                    'b,
                    ::flatbuffers::ForwardsUOffset<ChunkIndices<'b>>,
                >,
            >,
        ) {
            self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(
    ...
    impl<'a> MoveOperation<'a> {
        ...
        #[inline]
        pub fn node_id(&self) -> Option<&'a ObjectId8> {
            // Safety:
            // Created from valid Table for this object
            // which contains a valid value in this slot
        ...
        > {
            ...
            unsafe {
                self._tab.get::<::flatbuffers::ForwardsUOffset<
                    ::flatbuffers::Vector<
                        'a,
                        ::flatbuffers::ForwardsUOffset<MoveOperation>,
                    >,
    ...
    pub struct TransactionLogArgs<'a> {
        ...
        pub moved_nodes: Option<
            ::flatbuffers::WIPOffset<
                ::flatbuffers::Vector<
                    'a,
                    ::flatbuffers::ForwardsUOffset<MoveOperation<'a>>,
                >,
            >,
        >,
        pub extra: Option<::flatbuffers::WIPOffset<::flatbuffers::Vector<'a, u8>>>,
    ...
    impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> TransactionLogBuilder<'a, 'b, A> {
        ...
        pub fn add_deleted_groups(
            &mut self,
            deleted_groups: ::flatbuffers::WIPOffset<
        ...
        pub fn add_deleted_arrays(
            &mut self,
            deleted_arrays: ::flatbuffers::WIPOffset<
                ::flatbuffers::Vector<'b, ObjectId8>,
            >,
        ) {
            self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(
        ...
        pub fn add_updated_arrays(
            &mut self,
            updated_arrays: ::flatbuffers::WIPOffset<
                ::flatbuffers::Vector<'b, ObjectId8>,
            >,
        ) {
            self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(
        ...
        pub fn add_updated_groups(
            &mut self,
            updated_groups: ::flatbuffers::WIPOffset<
                ::flatbuffers::Vector<'b, ObjectId8>,
            >,
        ) {
            self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(
        ...
        pub fn add_moved_nodes(
            ...
            moved_nodes: ::flatbuffers::WIPOffset<
                ::flatbuffers::Vector<
                    'b,
                    ::flatbuffers::ForwardsUOffset<MoveOperation<'b>>,
                >,
            >,
        ) {
            self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(
    ...
    pub struct RepoStatusChangedUpdateBuilder<
        'a: 'b,
        'b,
    ...
    impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> UpdateBuilder<'a, 'b, A> {
        ...
        #[inline]
        pub fn add_backup_path(
            &mut self,
            backup_path: ::flatbuffers::WIPOffset<&'b str>,
        ) {
            self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(
                Update::VT_BACKUP_PATH,
                backup_path,
    ...
    impl<'a> Repo<'a> {
        ...
        pub const VT_EXTRA: ::flatbuffers::VOffsetT = 28;
    ...
    pub struct RepoArgs<'a> {
        ...
        pub snapshots: Option<
            ::flatbuffers::WIPOffset<
                ::flatbuffers::Vector<
                    'a,
                    ::flatbuffers::ForwardsUOffset<SnapshotInfo<'a>>,
                >,
            >,
        >,
        pub status: Option<::flatbuffers::WIPOffset<RepoStatus<'a>>>,
    ...
    impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> RepoBuilder<'a, 'b, A> {
        ...
        pub fn add_tags(
            ...
            self.fbb_
                .push_slot_always::<::flatbuffers::WIPOffset<_>>(Repo::VT_TAGS, tags);
        }
        #[inline]
        pub fn add_branches(
            &mut self,
        ...
        pub fn add_snapshots(
            ...
            snapshots: ::flatbuffers::WIPOffset<
                ::flatbuffers::Vector<
                    'b,
                    ::flatbuffers::ForwardsUOffset<SnapshotInfo<'b>>,
                >,
            >,
        ) {
            self.fbb_.push_slot_always::<::flatbuffers::WIPOffset<_>>(
        ...
        pub fn add_config(
            &mut self,
            config: ::flatbuffers::WIPOffset<::flatbuffers::Vector<'b, u8>>,
        ) {
            self.fbb_
        ...
        pub fn add_extra(
            ...
            self.fbb_
                .push_slot_always::<::flatbuffers::WIPOffset<_>>(Repo::VT_EXTRA, extra);
        }
        #[inline]
        pub fn new(
            _fbb: &'b mut ::flatbuffers::FlatBufferBuilder<'a, A>,
