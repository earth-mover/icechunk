...
impl<'b> flatbuffers::Push for ManifestFileInfo {
    ...
    #[inline]
    unsafe fn push(&self, dst: &mut [u8], _written_len: usize) {
        let src = ::core::slice::from_raw_parts(self as *const ManifestFileInfo as *const u8, <Self as flatbuffers::Push>::size());
        dst.copy_from_slice(src);
    }
    #[inline]
    fn alignment() -> flatbuffers::PushAlignment {
...
impl<'b> flatbuffers::Push for DimensionShape {
    ...
    #[inline]
    unsafe fn push(&self, dst: &mut [u8], _written_len: usize) {
        let src = ::core::slice::from_raw_parts(self as *const DimensionShape as *const u8, <Self as flatbuffers::Push>::size());
        dst.copy_from_slice(src);
    }
    #[inline]
    fn alignment() -> flatbuffers::PushAlignment {
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> MetadataItemBuilder<'a, 'b, A> {
  ...
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> MetadataItemBuilder<'a, 'b, A> {
...
impl<'a> DimensionName<'a> {
  ...
  pub fn name(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(DimensionName::VT_NAME, None)}
  }
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> DimensionNameBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_name(&mut self, name: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(DimensionName::VT_NAME, name);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> DimensionNameBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
    DimensionNameBuilder {
      fbb_: _fbb,
      start_: start,
    }
  }
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> GroupNodeDataBuilder<'a, 'b, A> {
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> GroupNodeDataBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
    GroupNodeDataBuilder {
      fbb_: _fbb,
      start_: start,
    }
  }
...
impl<'a> ArrayNodeData<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: flatbuffers::Allocator + 'bldr>(
    ...
    if let Some(x) = args.manifests { builder.add_manifests(x); }
  ...
  pub fn shape(&self) -> flatbuffers::Vector<'a, DimensionShape> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, DimensionShape>>>(ArrayNodeData::VT_SHAPE, None).unwrap()}
  }
  #[inline]
  pub fn dimension_names(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<DimensionName<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<DimensionName>>>>(ArrayNodeData::VT_DIMENSION_NAMES, None)}
  }
  #[inline]
  pub fn manifests(&self) -> flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<ManifestRef<'a>>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<ManifestRef>>>>(ArrayNodeData::VT_MANIFESTS, None).unwrap()}
  }
}
...
pub struct ArrayNodeDataArgs<'a> {
    pub shape: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, DimensionShape>>>,
    pub dimension_names: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<DimensionName<'a>>>>>,
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> ArrayNodeDataBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_shape(&mut self, shape: flatbuffers::WIPOffset<flatbuffers::Vector<'b , DimensionShape>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(ArrayNodeData::VT_SHAPE, shape);
  }
  #[inline]
  pub fn add_dimension_names(&mut self, dimension_names: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<DimensionName<'b >>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(ArrayNodeData::VT_DIMENSION_NAMES, dimension_names);
  }
  #[inline]
  pub fn add_manifests(&mut self, manifests: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<ManifestRef<'b >>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(ArrayNodeData::VT_MANIFESTS, manifests);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> ArrayNodeDataBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
    ArrayNodeDataBuilder {
      fbb_: _fbb,
      start_: start,
    }
  }
...
impl<'a> NodeSnapshot<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: flatbuffers::Allocator + 'bldr>(
    ...
    if let Some(x) = args.node_data { builder.add_node_data(x); }
  ...
  pub fn path(&self) -> &'a str {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(NodeSnapshot::VT_PATH, None).unwrap()}
  }
  #[inline]
  pub fn user_data(&self) -> flatbuffers::Vector<'a, u8> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(NodeSnapshot::VT_USER_DATA, None).unwrap()}
  }
  #[inline]
  pub fn node_data_type(&self) -> NodeData {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<NodeData>(NodeSnapshot::VT_NODE_DATA_TYPE, Some(NodeData::NONE)).unwrap()}
  }
  #[inline]
  pub fn node_data(&self) -> flatbuffers::Table<'a> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Table<'a>>>(NodeSnapshot::VT_NODE_DATA, None).unwrap()}
  }
  #[inline]
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> NodeSnapshotBuilder<'a, 'b, A> {
  ...
  pub fn add_path(&mut self, path: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(NodeSnapshot::VT_PATH, path);
  }
  #[inline]
  pub fn add_user_data(&mut self, user_data: flatbuffers::WIPOffset<flatbuffers::Vector<'b , u8>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(NodeSnapshot::VT_USER_DATA, user_data);
  }
  #[inline]
  pub fn add_node_data_type(&mut self, node_data_type: NodeData) {
    self.fbb_.push_slot::<NodeData>(NodeSnapshot::VT_NODE_DATA_TYPE, node_data_type, NodeData::NONE);
  }
  #[inline]
  pub fn add_node_data(&mut self, node_data: flatbuffers::WIPOffset<flatbuffers::UnionWIPOffset>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(NodeSnapshot::VT_NODE_DATA, node_data);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> NodeSnapshotBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
    NodeSnapshotBuilder {
      fbb_: _fbb,
      start_: start,
...
impl<'a> Snapshot<'a> {
  ...
  pub fn message(&self) -> &'a str {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(Snapshot::VT_MESSAGE, None).unwrap()}
  }
  #[inline]
  pub fn metadata(&self) -> flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<MetadataItem<'a>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<MetadataItem>>>>(Snapshot::VT_METADATA, None).unwrap()}
  }
  #[inline]
  pub fn manifest_files(&self) -> flatbuffers::Vector<'a, ManifestFileInfo> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, ManifestFileInfo>>>(Snapshot::VT_MANIFEST_FILES, None).unwrap()}
  }
}
...
pub struct SnapshotArgs<'a> {
    ...
    pub manifest_files: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, ManifestFileInfo>>>,
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> SnapshotBuilder<'a, 'b, A> {
  ...
  pub fn add_message(&mut self, message: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Snapshot::VT_MESSAGE, message);
  }
  #[inline]
  pub fn add_metadata(&mut self, metadata: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<MetadataItem<'b >>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Snapshot::VT_METADATA, metadata);
  }
  #[inline]
  pub fn add_manifest_files(&mut self, manifest_files: flatbuffers::WIPOffset<flatbuffers::Vector<'b , ManifestFileInfo>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Snapshot::VT_MANIFEST_FILES, manifest_files);
  }
  #[inline]
...
impl<'a> TransactionLog<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: flatbuffers::Allocator + 'bldr>(
    ...
    if let Some(x) = args.updated_groups { builder.add_updated_groups(x); }
    if let Some(x) = args.updated_arrays { builder.add_updated_arrays(x); }
  ...
  pub fn updated_arrays(&self) -> flatbuffers::Vector<'a, ObjectId8> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, ObjectId8>>>(TransactionLog::VT_UPDATED_ARRAYS, None).unwrap()}
  }
  #[inline]
  pub fn updated_groups(&self) -> flatbuffers::Vector<'a, ObjectId8> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, ObjectId8>>>(TransactionLog::VT_UPDATED_GROUPS, None).unwrap()}
  }
  #[inline]
...
pub struct TransactionLogArgs<'a> {
    ...
    pub updated_arrays: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, ObjectId8>>>,
    pub updated_groups: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, ObjectId8>>>,
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> TransactionLogBuilder<'a, 'b, A> {
  ...
  #[inline]
  pub fn add_updated_arrays(&mut self, updated_arrays: flatbuffers::WIPOffset<flatbuffers::Vector<'b , ObjectId8>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(TransactionLog::VT_UPDATED_ARRAYS, updated_arrays);
  }
  #[inline]
  pub fn add_updated_groups(&mut self, updated_groups: flatbuffers::WIPOffset<flatbuffers::Vector<'b , ObjectId8>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(TransactionLog::VT_UPDATED_GROUPS, updated_groups);
  }
  #[inline]
...
impl<'a> Ref<'a> {
  ...
  pub fn name(&self) -> &'a str {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(Ref::VT_NAME, None).unwrap()}
  }
  #[inline]
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> RefBuilder<'a, 'b, A> {
  ...
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> RefBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
    RefBuilder {
      fbb_: _fbb,
      start_: start,
...
impl<'a> SnapshotInfo<'a> {
  ...
  pub fn parent_offset(&self) -> i32 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<i32>(SnapshotInfo::VT_PARENT_OFFSET, Some(0)).unwrap()}
  }
  #[inline]
  pub fn flushed_at(&self) -> u64 {
    // Safety:
  ...
  pub fn message(&self) -> &'a str {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(SnapshotInfo::VT_MESSAGE, None).unwrap()}
  }
  #[inline]
  pub fn metadata(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<MetadataItem<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<MetadataItem>>>>(SnapshotInfo::VT_METADATA, None)}
  }
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> SnapshotInfoBuilder<'a, 'b, A> {
  ...
  #[inline]
  pub fn add_message(&mut self, message: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(SnapshotInfo::VT_MESSAGE, message);
  }
  #[inline]
  pub fn add_metadata(&mut self, metadata: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<MetadataItem<'b >>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(SnapshotInfo::VT_METADATA, metadata);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> SnapshotInfoBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
    SnapshotInfoBuilder {
      fbb_: _fbb,
      start_: start,
...
impl<'a> RepoStatus<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: flatbuffers::Allocator + 'bldr>(
    ...
    if let Some(x) = args.limited_availability_reason { builder.add_limited_availability_reason(x); }
  ...
  pub fn availability(&self) -> RepoAvailability {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<RepoAvailability>(RepoStatus::VT_AVAILABILITY, Some(RepoAvailability::Online)).unwrap()}
  }
  #[inline]
  ...
  pub fn limited_availability_reason(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(RepoStatus::VT_LIMITED_AVAILABILITY_REASON, None)}
  }
}
...
impl flatbuffers::Verifiable for RepoStatus<'_> {
  ...
  fn run_verifier(
    ...
    use self::flatbuffers::Verifiable;
    v.visit_table(pos)?
     .visit_field::<RepoAvailability>("availability", Self::VT_AVAILABILITY, false)?
     .visit_field::<u64>("set_at", Self::VT_SET_AT, false)?
     .visit_field::<flatbuffers::ForwardsUOffset<&str>>("limited_availability_reason", Self::VT_LIMITED_AVAILABILITY_REASON, false)?
     .finish();
    Ok(())
  }
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> RepoStatusBuilder<'a, 'b, A> {
  ...
  pub fn add_availability(&mut self, availability: RepoAvailability) {
    self.fbb_.push_slot::<RepoAvailability>(RepoStatus::VT_AVAILABILITY, availability, RepoAvailability::Online);
  }
  #[inline]
  ...
  #[inline]
  pub fn add_limited_availability_reason(&mut self, limited_availability_reason: flatbuffers::WIPOffset<&'b  str>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(RepoStatus::VT_LIMITED_AVAILABILITY_REASON, limited_availability_reason);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> RepoStatusBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
    RepoStatusBuilder {
      fbb_: _fbb,
      start_: start,
...
impl<'a> Repo<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: flatbuffers::Allocator + 'bldr>(
    ...
    if let Some(x) = args.deleted_tags { builder.add_deleted_tags(x); }
  ...
  #[inline]
  pub fn tags(&self) -> flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Ref<'a>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Ref>>>>(Repo::VT_TAGS, None).unwrap()}
  }
  #[inline]
  pub fn branches(&self) -> flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Ref<'a>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Ref>>>>(Repo::VT_BRANCHES, None).unwrap()}
  }
  #[inline]
  pub fn deleted_tags(&self) -> flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>>>(Repo::VT_DELETED_TAGS, None).unwrap()}
  }
  #[inline]
  pub fn snapshots(&self) -> flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<SnapshotInfo<'a>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<SnapshotInfo>>>>(Repo::VT_SNAPSHOTS, None).unwrap()}
  }
  #[inline]
  ...
  pub fn status(&self) -> RepoStatus<'a> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<RepoStatus>>(Repo::VT_STATUS, None).unwrap()}
  }
  #[inline]
  pub fn metadata(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<MetadataItem<'a>>>> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<MetadataItem>>>>(Repo::VT_METADATA, None)}
  }
}
...
pub struct RepoArgs<'a> {
    pub tags: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Ref<'a>>>>>,
    pub branches: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<Ref<'a>>>>>,
    pub deleted_tags: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<&'a str>>>>,
    pub snapshots: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<SnapshotInfo<'a>>>>>,
    pub spec_version: u8,
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> RepoBuilder<'a, 'b, A> {
  #[inline]
  pub fn add_tags(&mut self, tags: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<Ref<'b >>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Repo::VT_TAGS, tags);
  }
  #[inline]
  pub fn add_branches(&mut self, branches: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<Ref<'b >>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Repo::VT_BRANCHES, branches);
  }
  #[inline]
  pub fn add_deleted_tags(&mut self, deleted_tags: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<&'b  str>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Repo::VT_DELETED_TAGS, deleted_tags);
  }
  #[inline]
  pub fn add_snapshots(&mut self, snapshots: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<SnapshotInfo<'b >>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Repo::VT_SNAPSHOTS, snapshots);
  }
  #[inline]
  ...
  pub fn add_status(&mut self, status: flatbuffers::WIPOffset<RepoStatus<'b >>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<RepoStatus>>(Repo::VT_STATUS, status);
  }
  #[inline]
  pub fn add_metadata(&mut self, metadata: flatbuffers::WIPOffset<flatbuffers::Vector<'b , flatbuffers::ForwardsUOffset<MetadataItem<'b >>>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Repo::VT_METADATA, metadata);
  }
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> RepoBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
    RepoBuilder {
      fbb_: _fbb,
      start_: start,
