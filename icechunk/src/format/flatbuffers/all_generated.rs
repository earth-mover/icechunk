...
impl core::fmt::Debug for AttributeFileInfo {
  fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
    f.debug_struct("AttributeFileInfo")
      .field("id", &self.id())
      .finish()
  }
}
...
impl<'b> flatbuffers::Push for AttributeFileInfo {
    ...
    #[inline]
    unsafe fn push(&self, dst: &mut [u8], _written_len: usize) {
        let src = ::core::slice::from_raw_parts(self as *const AttributeFileInfo as *const u8, <Self as flatbuffers::Push>::size());
        dst.copy_from_slice(src);
    }
    #[inline]
    fn alignment() -> flatbuffers::PushAlignment {
...
impl<'a> UserAttributesRef<'a> {
  ...
  pub fn location(&self) -> u32 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<u32>(UserAttributesRef::VT_LOCATION, Some(0)).unwrap()}
  }
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> UserAttributesRefBuilder<'a, 'b, A> {
  ...
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> UserAttributesRefBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
    UserAttributesRefBuilder {
      fbb_: _fbb,
      start_: start,
    }
  }
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> InlineUserAttributesBuilder<'a, 'b, A> {
  ...
  #[inline]
  pub fn new(_fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>) -> InlineUserAttributesBuilder<'a, 'b, A> {
    let start = _fbb.start_table();
    InlineUserAttributesBuilder {
      fbb_: _fbb,
      start_: start,
    }
  }
...
impl<'a> ArrayNodeData<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: flatbuffers::Allocator + 'bldr>(
    ...
    if let Some(x) = args.zarr_metadata { builder.add_zarr_metadata(x); }
    builder.finish()
  }
...
impl<'a> NodeSnapshot<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: flatbuffers::Allocator + 'bldr>(
    ...
    if let Some(x) = args.user_attributes { builder.add_user_attributes(x); }
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> NodeSnapshotBuilder<'a, 'b, A> {
  ...
  #[inline]
  pub fn add_user_attributes_type(&mut self, user_attributes_type: UserAttributesSnapshot) {
    self.fbb_.push_slot::<UserAttributesSnapshot>(NodeSnapshot::VT_USER_ATTRIBUTES_TYPE, user_attributes_type, UserAttributesSnapshot::NONE);
  }
  #[inline]
  pub fn add_user_attributes(&mut self, user_attributes: flatbuffers::WIPOffset<flatbuffers::UnionWIPOffset>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(NodeSnapshot::VT_USER_ATTRIBUTES, user_attributes);
  }
  #[inline]
...
impl<'a> Snapshot<'a> {
  ...
  pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: flatbuffers::Allocator + 'bldr>(
    ...
    if let Some(x) = args.attribute_files { builder.add_attribute_files(x); }
  ...
  pub fn attribute_files(&self) -> flatbuffers::Vector<'a, AttributeFileInfo> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, AttributeFileInfo>>>(Snapshot::VT_ATTRIBUTE_FILES, None).unwrap()}
  }
}
...
pub struct SnapshotArgs<'a> {
    ...
    pub attribute_files: Option<flatbuffers::WIPOffset<flatbuffers::Vector<'a, AttributeFileInfo>>>,
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> SnapshotBuilder<'a, 'b, A> {
  ...
  #[inline]
  pub fn add_attribute_files(&mut self, attribute_files: flatbuffers::WIPOffset<flatbuffers::Vector<'b , AttributeFileInfo>>) {
    self.fbb_.push_slot_always::<flatbuffers::WIPOffset<_>>(Snapshot::VT_ATTRIBUTE_FILES, attribute_files);
  }
  #[inline]
