...
Bytes 0-11:  Magic bytes "ICE<ice-cube-emoji>CHUNK" (12 bytes total)
...
+------------------------------------------------------------------+
| flushed_at: u64               # Creation timestamp               |
+------------------------------------------------------------------+
| message: string               # Commit message                   |
+------------------------------------------------------------------+
...
+------------------------------------------------------------------+
| moved_nodes: [MoveOperation]? # Renamed/moved nodes              |
...
- Snapshot `parent_id` creates a DAG of version history
