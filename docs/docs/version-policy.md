...
All Icechunk major versions will continue to receive **bug fixes and security patches for at least one year** after they are superseded by a new major version. This guarantees at least a one-year window to upgrade. For example, if Icechunk 2.0 is released on April 1, 2026, Icechunk 1.x will receive bug and security fixes until at least April 1, 2027.
