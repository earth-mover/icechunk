...
We present a diagram of a repository snapshots. Arrows follow the `parent`
relationship. Above in the diagram is the original repo, and below, we show
...
to abandon a stream of contiguous snapshots `X1, X2,..., Xn` that seats
