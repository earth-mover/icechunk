...
class CachingConfig:
    ...
    def __init__(
        ...
        snapshots_nodes: int,
        manifests_refs: int,
        transactions_records: int,
        attributes_bytes: int,
        chunks_bytes: int,
    ) -> None: ...
    @property
    def snapshots_nodes(self) -> int: ...
    @snapshots_nodes.setter
    def snapshots_nodes(self, value: int) -> None: ...
    @property
    def manifests_refs(self) -> int: ...
    @manifests_refs.setter
    def manifests_refs(self, value: int) -> None: ...
    @property
    def transactions_records(self) -> int: ...
    @transactions_records.setter
    def transactions_records(self, value: int) -> None: ...
    @property
    def attributes_bytes(self) -> int: ...
    @attributes_bytes.setter
    def attributes_bytes(self, value: int) -> None: ...
    @property
    def chunks_bytes(self) -> int: ...
    @chunks_bytes.setter
    def chunks_bytes(self, value: int) -> None: ...
    @staticmethod
