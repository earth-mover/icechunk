...
class CachingConfig:
    ...
    def __init__(
        self,
        num_snapshot_nodes: int,
        num_chunk_refs: int,
        num_transaction_changes: int,
        num_bytes_attributes: int,
        num_bytes_chunks: int,
    ) -> None: ...
    @property
    def num_snapshot_nodes(self) -> int: ...
    @num_snapshot_nodes.setter
    def num_snapshot_nodes(self, value: int) -> None: ...
    @property
    def num_chunk_refs(self) -> int: ...
    @num_chunk_refs.setter
    def num_chunk_refs(self, value: int) -> None: ...
    @property
    def num_transaction_changes(self) -> int: ...
    @num_transaction_changes.setter
    def num_transaction_changes(self, value: int) -> None: ...
    @property
    def num_bytes_attributes(self) -> int: ...
    @num_bytes_attributes.setter
    def num_bytes_attributes(self, value: int) -> None: ...
    @property
    def num_bytes_chunks(self) -> int: ...
    @num_bytes_chunks.setter
    def num_bytes_chunks(self, value: int) -> None: ...
    @staticmethod
