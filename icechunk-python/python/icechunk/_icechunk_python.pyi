...
class PyRepository:
    ...
    @classmethod
    async def from_bytes_async(cls, data: bytes) -> PyRepository: ...
    ...
    async def set_default_commit_metadata_async(
...
class PySession:
    ...
    @classmethod
    async def from_bytes_async(cls, data: bytes) -> PySession: ...
    ...
    async def store_async(self) -> PyStore: ...
...
class PyStore:
    ...
    @classmethod
    async def from_bytes_async(cls, data: bytes) -> PyStore: ...
    def __eq__(self, value: object) -> bool: ...
    @property
    def read_only(self) -> bool: ...
    async def read_only_async(self) -> bool: ...
