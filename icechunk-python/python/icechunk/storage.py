...
def tigris_storage(
    *,
    ...
    eventually_consistent: bool
        If set to True it will return a Storage instance that is read only but can read from the
        the closest Tigris region. Behavior is undefined if objects haven't propagated to the region.
