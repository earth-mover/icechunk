...
Icechunk figures out how to materialize these keys based on its [storage schema](../reference/spec-v2-1.md).
...
Many of the [spec](../reference/spec-v2-1.md) core requirements are similar to Iceberg.
