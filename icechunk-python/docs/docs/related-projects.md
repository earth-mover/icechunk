...
!!! note
    ...
    This is a community-built alternative to the official [Icechunk JavaScript/TypeScript package](https://github.com/earth-mover/icechunk/tree/main/icechunk-js), which provides full read-write support via NAPI and WASM bindings.
