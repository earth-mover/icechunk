...
# Suppress LocalFileSystem warnings from both packages
_LOG_FILTER = "warn,icechunk::storage::object_store=error"
ic.set_logs_filter(_LOG_FILTER)
if hasattr(ic_v1, "set_logs_filter"):
    ic_v1.set_logs_filter(_LOG_FILTER)
