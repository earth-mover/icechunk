...
#[pymethods]
impl PyStorage {
    #[pyo3(signature = ( config, bucket, prefix, credentials=None, legacy_rooted_keys=false))]
    #[classmethod]
    pub(crate) fn new_s3(
        _cls: &Bound<'_, PyType>,
        config: &PyS3Options,
    ...
    #[pyo3(signature = ( config, bucket, prefix, use_weak_consistency, credentials=None, legacy_rooted_keys=false))]
    #[classmethod]
    ...
    #[pyo3(signature = ( config, bucket=None, prefix=None, account_id=None, credentials=None, legacy_rooted_keys=false))]
    #[classmethod]
    pub(crate) fn new_r2(
        _cls: &Bound<'_, PyType>,
        config: &PyS3Options,
